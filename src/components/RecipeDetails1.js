...
//      this.state = {
//        recipe: recipe,
//        url: `https://www.food2fork.com/api/get?key=7d6162d13188077db34b2c936e7aee58&rId=${
//          this.props.id
//        }`
//      };
//   }
...
async componentDidMount() {
  ...
  const url = `https://www.food2fork.com/api/get?key=7d6162d13188077db34b2c936e7aee58&rId=${id}`;
  try {
